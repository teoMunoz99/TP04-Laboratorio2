...
<main class="container d-flex justify-content-center align-items-center">
    <section class="bg-dark text-light rounded-4 p-4 w-25">
        <form action="php/procesa.php" method="POST">
            ...
            <p class="text-secondary text-center"><small>Ingrese su mail y contraseña</small></p>
            <fieldset class="disabled">
                <section class="mb-3">
                    <label for="nombre" class="form-label">Correo electronico</label>
                    <input type="email" class="form-control" id="nombre" aria-describedby="emailHelp" name="email">
                </section>
                <section>
